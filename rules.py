...
def total_revenue(data: dict, financial_index):
    ...
    """
    fin = data["financials"][financial_index]
    net_revenue = fin["pnl"]["lineItems"]["net_revenue"]
    return net_revenue
...
def total_borrowing(data: dict, financial_index):
    ...
    long_term_borrowing = bs["liabilities"]["long_term_borrowings"]
    short_term_borrowing = bs["liabilities"]["short_term_borrowings"]
    total_borrowing = long_term_borrowing + short_term_borrowing
    totalRevenue = total_revenue(data, financial_index)
    return total_borrowing/totalRevenue 
...
def iscr(data: dict, financial_index):
    ...
    """
    fin = data["financials"][financial_index]["pnl"]
    profit_before = fin["lineItems"]["profit_before_interest_and_tax"] + fin["lineItems"]["profit_before_tax"] + fin["lineItems"]["profit_before_tax_and_exceptional_items_before_tax"] + 1
    expenses = fin["lineItems"]["total_other_expenses"] + fin["lineItems"]["total_employee_benefit_expense"] + 1
    return profit_before//expenses
...
def borrowing_to_revenue_flag(data: dict, financial_index):
    ...
    """
    totalBorrowing = total_borrowing(data, financial_index)
    if totalBorrowing <= 0.25:
        return "GREEN"
    else:
        return "AMBER"